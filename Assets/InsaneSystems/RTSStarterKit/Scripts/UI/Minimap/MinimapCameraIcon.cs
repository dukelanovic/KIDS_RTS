...
{
	public sealed class MinimapCameraIcon : MonoBehaviour, IBeginDragHandler, IEndDragHandler
	{
		...
		void HandleCameraIcon()
		{
			...
			if (Physics.Raycast(mainCamera.transform.position, mainCamera.transform.forward, out var hit, 1000))
		...
		public void SetIconPosition(Vector2 newPosition, bool updateCameraPosition = false)
		{
			...
			{ 
				var worldPosition = UIPositionToWorld(rectTransform.anchoredPosition, true);
