...
{
	[CreateAssetMenu(fileName = "Storage", menuName = AssetName + "/Storage")]
	public class Storage : ScriptableObject
	{
		public const string AssetName = "RTS Starter Kit";
		
		[Header("Application Settings")] 
		[Tooltip("Set -1 to remove FPS cap. Keep in mind, that it is not recommended.")]
		public int DesiredFpsCap = 120;
		...
		[Tooltip("Customize it with your own components if you need custom Ai code.")]
		public GameObject AiControllerPrefab;
		
		[Tooltip("Add here default win condition.")]
		public WinCondition defaultWinCondition;
		...
		public int CameraScreenBorderForMouse = 10;
		[Tooltip("Sets camera move speed.")]
		[Range(2f, 30f)] public float CameraSensivity = 5f;
		[Tooltip("Max camera zoom value. Select value which is better for you. Big values can cause problems with camera.")]
		[Range(0f, 50f)] public float MaxCameraZoom = 10f;
		[Range(1, 100)] public float CameraZoomSpeed = 30f;
		public bool allowCameraRotation = true;
		public bool allowCameraZoom = true;
		public CameraMover.CameraMoveType CameraMoveType = CameraMover.CameraMoveType.SpeedupFromCenter;
		...
		[Tooltip("How fast unit will get its maximum speed. It is a NavMesh parameter, and it affects unit visual rotation speed. So it is recommended to use high value as acceleration in the RTS games.")]
		[Range(0.1f, 10000f)] public float UnitsAcceleration = 2000;
		[Tooltip("Ground Angle Rotation speed of units in degrees/sec.")]
		[Range(0.1f, 180f)] public float UnitsGroundRotationSpeed = 3.5f;
	...
	public class CommentAttribute : PropertyAttribute
	{
		...
		public CommentAttribute(string commentText = "Comment text")
		{
			Comment = commentText;
		}
	}
