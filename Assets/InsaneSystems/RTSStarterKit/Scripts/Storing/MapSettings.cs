...
{
	[CreateAssetMenu(fileName = "MapSettings", menuName = Storage.AssetName + "/Map Settings")]
	public class MapSettings : ScriptableObject
	{
		...
		[Tooltip("Add here win condition for this map.")]
		...
		public void LoadMap() => SceneManager.LoadScene(mapSceneName);
	}
}
